<!DOCTYPE html>
<?php include("stafffunc.php"); ?>
<html>
<head>
	<title>Détails des employés</title>
...
<div class="card-body" style="background-color:#3398DB; color:#ffffff;">
	<div class="row"> 
		<div class="col-md-4">
	<h3>Détails des employés</h3></div>
<div class="col-md-8">
	<form class="form-group" action="stafffunc.php" method="post">
	<div class="row">
	<div class="col-md-10"><input type="text" name="search" class="form-control" placeholder="Rechercher" style="float: right;"></div>
	<div class="col-md-2"><input type="submit" name="staff_search_submit" class="btn btn-light" value="Rechercher"style="float: right;"></div>
</div>
	</form>
</div>
</div>
